...
import { sections, guidesList, conceptsList, type Section, type Rule } from '@/content/generated';
    ...
    <nav className="space-y-6" aria-label="Main navigation">
      ...
      <div className="space-y-1">
        ...
        {sections.map((section) => {
          ...
          return <NavSection key={section.id} section={section} isActive={isActive} />;
        })}
      </div>
    </nav>
  );
