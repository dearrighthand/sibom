...
function GuidePage() {
  ...
  const nextGuide = currentIndex < guidesList.length - 1 ? guidesList[currentIndex + 1] : null;
  ...
  return (
    <article className="space-y-8">
      ...
      {/* Navigation */}
      <nav aria-label="Guide navigation" className="mt-12 grid gap-4 sm:grid-cols-2">
        {prevGuide ? (
          <Link
            to="/guides/$slug"
          ...
          >
            ...
            <span className="font-medium group-hover:text-primary">{prevGuide.title}</span>
          </Link>
        ) : (
          <div />
        )}
        {nextGuide ? (
          ...
          >
            ...
            <span className="font-medium group-hover:text-primary">{nextGuide.title}</span>
          </Link>
        ) : (
          <div />
        )}
