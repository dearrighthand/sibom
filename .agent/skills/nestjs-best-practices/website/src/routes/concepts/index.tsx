  ...
  return (
    <div className="space-y-8">
      <header className="space-y-4">
        <h1 className="text-3xl font-bold tracking-tight sm:text-4xl">Concepts</h1>
        <p className="max-w-2xl text-lg text-muted-foreground">
          Understand the core concepts that power NestJS applications. These explanations help you
          grasp the "why" behind the patterns.
        </p>
      </header>
                ...
                {concepts.map((concept) => (
                  ...
                  >
                    <div className="space-y-2">
                      <h3 className="font-semibold group-hover:text-primary">{concept.title}</h3>
