...
export class ResourceOwnerGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    const resourceService = this.reflector.get<Type>('resourceService', context.getHandler());
...
// decorator
export const CheckOwnership = (service: Type) => SetMetadata('resourceService', service);
