...
// app.module.ts
@Module({
  imports: [UsersModule, ProductsModule, OrdersModule, SharedModule],
})
...
@Module({
  providers: [LoggerService, CacheService, DateUtilsService],
  exports: [LoggerService, CacheService, DateUtilsService],
})
