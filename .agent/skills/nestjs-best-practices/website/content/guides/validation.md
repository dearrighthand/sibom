...
import { IsArray, IsInt, IsPositive, IsString, IsUUID, Min, ValidateNested } from 'class-validator';
...
```typescript
// dto/payment.dto.ts
import { IsEnum, IsString, ValidateIf, IsCreditCard, IsIBAN } from 'class-validator';
